...
{
    public class When_saving_designer : UsingDesignerServiceSpec
    {
        ...
        public override void Context()
        {
            ...
            _designerRepository.Save(_designer).Returns(true);
        }
        ...
        {
            _designerRepository.Received(1).Save(_designer);
