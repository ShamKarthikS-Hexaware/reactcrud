...
{
    public class When_saving_developer : UsingDeveloperControllerSpec
    {
        ...
        public override void Context()
        {
            ...
            _developerService.Save(_developer).Returns(_developer);
        }
        ...
        {
            _developerService.Received(1).Save(_developer);
        ...
        public void Appropriate_result_is_returned()
        {
            ...
            var resultList = (Developer)resultListObject;
